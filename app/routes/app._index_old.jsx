      ...
      <div style={{
        ...
        {/* Stats Row */}
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'clamp(10px, 1.2vw, 12px)', color: '#151515' }}>Total Tests</div>
          </div>
          ...
          <div style={{
            ...
            <div style={{ fontSize: 'clamp(10px, 1.2vw, 12px)', color: '#151515' }}>Revenue</div>
          </div>
                ...
                <li key={activity.id} style={{ marginBottom: 'clamp(12px, 1.5vw, 16px)', position: 'relative' }}>
                  {activityIdx !== stats.recentActivity.length - 1 && (
                    <div style={{
                      ...
                      background: 'linear-gradient(to bottom, #0038FF 0%, transparent 100%)'
                    }}></div>
                  )}
